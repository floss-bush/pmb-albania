...
// +-------------------------------------------------+
// $Id: sms.inc.php,v 1.2 2010-05-18 14:49:22 ngantier Exp $
...
function send_sms($to_nom="", $telephone, $obj="", $corps="", $from_name="", $from_mail, $headers, $copie_CC="", $copie_BCC="", $faire_nl2br=0, $pieces_jointes=array()) {
	...
	$sms=new $param_list["class_name"];
	//($telephone, $message) 
	$retour=$sms->send_sms($telephone, $corps);
