...
// +-------------------------------------------------+
// $Id: aut_link.class.php,v 1.1 2010-06-16 12:13:47 ngantier Exp $
...
class aut_link {
	...
	function getdata() {
		...
		$rqt="select * from aut_link where aut_link_from='".$this->aut_table."' and aut_link_from_num='".$this->id."' order by aut_link_type ";
	...
	function delete() {
		...
		$requete="DELETE FROM aut_link WHERE aut_link_from='".$this->aut_table."' and aut_link_from_num='".$this->id."' ";
		mysql_query($requete, $dbh);
		$requete="DELETE FROM aut_link WHERE aut_link_to='".$this->aut_table."' and aut_link_from_to='".$this->id."' ";
		mysql_query($requete, $dbh);
	}	
// fin class
}