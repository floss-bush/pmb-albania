...
// +-------------------------------------------------+
// $Id: etageres_see.inc.php,v 1.12 2008-02-08 13:16:17 touraine37 Exp $
...
if ($showet) {
	...
	print pmb_bidi(affiche_etagere (1, "", 1, $opac_etagere_nbnotices_accueil, $opac_etagere_notices_format, $opac_etagere_notices_depliables, "./index.php?lvl=etagere_see&id=!!id!!", $liens_opac )) ; 
	print "\n";
}
?>