...
// +-------------------------------------------------+
// $Id: notice_tpl.inc.php,v 1.7.2.6 2011-10-07 14:13:05 arenou Exp $
...
function aff_header_link($param) {
	global $opac_url_base,$use_opac_url_base,$opac_url_base;
	...
	switch($param[1]){
		case 2:
			if($notice['notice_info']->notice->lien) {
				...
				else $libelle.= "<img src=\"".$opac_url_base."images/globe.gif\" border=\"0\" align=\"middle\" hspace=\"3\"";
				$libelle.= "alt=\"". $notice['notice_info']->notice->eformat. "\" title=\"". $notice['notice_info']->notice->eformat ."\">";
				$libelle.="</a>";
			} else	{
				$libelle="<a href=\"".$opac_url_base."?lvl=notice_display&id=".$parser_environnement['id_notice']."&code=!!code!!&emprlogin=!!login!!&date_conex=!!date_conex!!\">$param[0]</a>";
			}
		break;
		default:
			$libelle="<a href=\"".$opac_url_base."?lvl=notice_display&id=".$parser_environnement['id_notice']."&code=!!code!!&emprlogin=!!login!!&date_conex=!!date_conex!!\">$param[0]</a>";
